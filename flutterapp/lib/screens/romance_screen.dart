...
class RomanceScreen extends StatefulWidget {
  RomanceScreen({Key? key}) : super(key: key);
...
class _RomanceScreenState extends State<RomanceScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Libro> listaRomance = libroProvider.listaLibrosRomance;
    final List<Libro> listaRomPo = libroProvider.listaLibrosRomPo;
    return Stack(
      children: <Widget>[
        Scaffold(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage('assets/romi.jpg'),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: ListView.separated(
                          ...
                          itemCount: listaRomPo.length,
                          separatorBuilder: (context, _) => SizedBox(
                            width: 20,
                          ),
                          itemBuilder: (context, index) =>
                              buildCard(item: listaRomPo[index]),
                        ),
                      ),
                      SizedBox(
                        height: 40,
                      ...
                      Container(
                        ...
                        itemBuilder: (context, index) =>
                        buildTerr (item: listaRomance[index]),
                        )
                      ),
                      SizedBox(
                        height: 30,
